...
| **0075, 0076, 0077, 0082, 0080, 0083** | The remainder of the 2026-09-01 sweep, relative order unchanged. Correctly-tiered defects — 0075/0076/0077 protect every session working the rows below them, 0082/0080 are backlog scripts failing open, 0083 is live load since `verify` gained a second worktree prescription — but none moves the cost figure the promoted four above target. | *2026-09-01*, "The AetherWorks tool sweep" |
