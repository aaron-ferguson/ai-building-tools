...
|------|-------|------|--------|--------|
| 0150 | Make design hold its row with claim from Step 1, and release it with handoff | verify | in-progress |  |
...
| 0041 | Write release notes for what a work session delivered | develop | in-progress | 0128 |
