...
|------|-------|------|--------|--------|
| 0053 | Let the test harness print the line an assertion actually saw | develop | in-progress |  |
| 0074 | Give the suite one reporting rule and route the detail to disk | verify | in-progress |  |
