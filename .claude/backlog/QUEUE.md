...
|------|-------|------|--------|--------|
| 0180 | Decide what a sprint does on a red baseline, and which stage may fix a red no ticket owns | develop | in-progress |  |
...
| 0185 | Decide whether the sprint's run logs are committed, and what may appear in them if they are | design | in-progress |  |
