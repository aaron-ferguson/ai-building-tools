...
|------|-------|------|--------|--------|
| 0179 | Find why a stage reports a session id it never ran under, and stop anything trusting one | develop | in-progress |  |
| 0180 | Decide what a sprint does on a red baseline, and which stage may fix a red no ticket owns | develop | ready |  |
