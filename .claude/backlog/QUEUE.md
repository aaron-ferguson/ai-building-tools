...
| 0135 | Record what a sprint was estimated to cost against what it did, and estimate from that | verify | in-progress | 0128 |
...
| 0147 | Make claim name the declared paths that do not exist instead of reserving them | develop | in-progress |  |
