...
|------|-------|------|--------|--------|
| 0073 | Measure where a stage session's turns and tokens actually go | verify | ready |  |
| 0085 | Collapse the backlog protocol from a third of every session's turns to one command per stage boundary | design | in-progress |  |
...
| 0084 | Script the release chain and verify it against the installed bytes | develop | ready |  |
